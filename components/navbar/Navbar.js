    ...
    <>
      <div className="container mx-auto max-w-[1200px] py-2 w-[95%]">
        ...
        <div className={menuClass}>
          ...
          <Link href="/photoGallery" className="nav-menu cursor-pointer p-1">
            Photo Gallery
          </Link>
          <Link href="/notice" className="nav-menu cursor-pointer p-1">
            Notice
          </Link>
          <p className="nav-menu cursor-pointer p-1">Chapters</p>
          <Link href="/contactUs" className="nav-menu cursor-pointer p-1">
            Contact Us
          </Link>
        </div>
      </div>
